...
def add_object(s,context):
    fc=[];vr=[];SM=[]
    Bal=[];Par=[];Mer=[];Krm=[];Cam=[];Dos=[]
    blok=[]#    [ Tip ][             Balcony           [                    Fuga                        ] [  Parapet  ] [   Mermer  ] [       Krom      ] [  Cam  ]
    ...
    for i in range(s.lst):
        ...
        if blok[i][0]=='5':#Cam
            ...
            BE=len(fc)
            for F in range(BB,BE):Cam.append(F)
#OBJE -----------------------------------------------------------
    ...
    mesh.materials.append(MAT('Parapet',0.46,0.44,0.52))
    mesh.materials.append(MAT('Mermer', 0.90,0.85,0.80))
    mesh.materials.append(MAT('Krom',   0.50,0.55,0.60))
    mesh.materials.append(MAT('Cam',    0.50,0.80,1.00))
    mesh.materials.append(MAT('Doseme', 1.00,1.00,1.00))
    ...
    for i in Cam:mesh.polygons[i].material_index = 4
...
class OBJECT_OT_add_balcony(bpy.types.Operator):
    ...
    duz=IntProperty(min=  1,max=500,default=100,description="Balcony Genisligi")
    dhg=IntProperty(min=  1,max= 50,default= 17,description="Doseme Yuksekligi")
    dds=IntProperty(min=-50,max= 50,default= 10,description="Dis Yuksekligi")
    ddg=IntProperty(min=  0,max= 50,default= 10,description="Dis Genisligi")
    #Tip
    ls0=EnumProperty(items=(("1","Balcony",""),("2","Parapet",""),("3","Mermer",""),("4","Krom",""),("5","Cam","")),default="1")
    #Balcony
    by0=IntProperty(name='Yukseklik',min=1,max=200,default=80,description='Yukseklik')
    bk0=IntProperty(name='Kalinlik', min=1,max= 50,default=20,description='Kalinlik' )
    bf0=IntProperty(name='Fuga',     min=0,max=  8,default= 4,description='Fuga'     )
    ...
    #Parapet
    py0=IntProperty(name='Yukseklik',min=1,max=200,default=80,description='Yukseklik')
    pd0=IntProperty(name='Kalinlik', min=1,max= 50,default=10,description='Kalinlik' )
    #Mermer
    my0=IntProperty(name='Yukseklik',min=1,max=50,default=4,description='Yukseklik')
    mg0=IntProperty(name='Genislik', min=0,max=20,default=4,description='Genislik' )
    #Krom
    kt0=EnumProperty(items=(("1","Kare",""),("2","Yuvarlak","")))
    ky0=IntProperty(min=0,max=50,default=5,description='Bosluk'  )
    kk0=IntProperty(min=1,max=20,default=5,description='Kalinlik')
    #Cam
    cy0=IntProperty(name='Yukseklik',min=1,max=100,default=20,description='Yukseklik')
    #--------------------------------------------------------------
    #Tip
    ls1=EnumProperty(items=(("1","Balcony",""),("2","Parapet",""),("3","Mermer",""),("4","Krom",""),("5","Cam","")),default="3")
    #Balcony
    by1=IntProperty(name='Yukseklik',min=1,max=200,default=80,description='Yukseklik')
    bk1=IntProperty(name='Kalinlik', min=1,max= 50,default=20,description='Kalinlik' )
    bf1=IntProperty(name='Fuga',     min=0,max=  8,default= 0,description='Fuga'     )
    ...
    #Parapet
    py1=IntProperty(name='Yukseklik',min=1,max=200,default=80,description='Yukseklik')
    pd1=IntProperty(name='Kalinlik', min=1,max= 50,default=10,description='Kalinlik' )
    #Mermer
    my1=IntProperty(name='Yukseklik',min=1,max=50,default=4,description='Yukseklik')
    mg1=IntProperty(name='Genislik', min=0,max=20,default=4,description='Genislik' )
    #Krom
    kt1=EnumProperty(items=(("1","Kare",""),("2","Yuvarlak","")))
    ky1=IntProperty(min=0,max=50,default=5,description='Bosluk'  )
    kk1=IntProperty(min=1,max=20,default=5,description='Kalinlik')
    #Cam
    cy1=IntProperty(name='Yukseklik',min=1,max=100,default=20,description='Yukseklik')
    #--------------------------------------------------------------
    #Tip
    ls2=EnumProperty(items=(("1","Balcony",""),("2","Parapet",""),("3","Mermer",""),("4","Krom",""),("5","Cam","")),default="4")
    #Balcony
    by2=IntProperty(name='Yukseklik',min=1,max=200,default=80,description='Yukseklik')
    bk2=IntProperty(name='Kalinlik', min=1,max= 50,default=20,description='Kalinlik' )
    bf2=IntProperty(name='Fuga',     min=0,max=  8,default= 0,description='Fuga'     )
    ...
    #Parapet
    py2=IntProperty(name='Yukseklik',min=1,max=200,default=80,description='Yukseklik')
    pd2=IntProperty(name='Kalinlik', min=1,max= 50,default=10,description='Kalinlik' )
    #Mermer
    my2=IntProperty(name='Yukseklik',min=1,max=50,default=4,description='Yukseklik')
    mg2=IntProperty(name='Genislik', min=0,max=20,default=4,description='Genislik' )
    #Krom
    kt2=EnumProperty(items=(("1","Kare",""),("2","Yuvarlak","")),default="2")
    ky2=IntProperty(min=0,max=50,default=5,description='Bosluk'  )
    kk2=IntProperty(min=1,max=20,default=5,description='Kalinlik')
    #Cam
    cy2=IntProperty(name='Yukseklik',min=1,max=100,default=20,description='Yukseklik')
    #--------------------------------------------------------------
    #Tip
    ls3=EnumProperty(items=(("1","Balcony",""),("2","Parapet",""),("3","Mermer",""),("4","Krom",""),("5","Cam","")),default="4")
    #Balcony
    by3=IntProperty(name='Yukseklik',min=1,max=200,default=80,description='Yukseklik')
    bk3=IntProperty(name='Kalinlik', min=1,max= 50,default=20,description='Kalinlik' )
    bf3=IntProperty(name='Fuga',     min=0,max=  8,default= 0,description='Fuga'     )
    ...
    #Parapet
    py3=IntProperty(name='Yukseklik',min=1,max=200,default=80,description='Yukseklik')
    pd3=IntProperty(name='Kalinlik', min=1,max= 50,default=10,description='Kalinlik' )
    #Mermer
    my3=IntProperty(name='Yukseklik',min=1,max=50,default=4,description='Yukseklik')
    mg3=IntProperty(name='Genislik', min=0,max=20,default=4,description='Genislik' )
    #Krom
    kt3=EnumProperty(items=(("1","Kare",""),("2","Yuvarlak","")))
    ky3=IntProperty(min=0,max=50,default=5,description='Bosluk'  )
    kk3=IntProperty(min=1,max=20,default=5,description='Kalinlik')
    #Cam
    cy3=IntProperty(name='Yukseklik',min=1,max=100,default=20,description='Yukseklik')
    #--------------------------------------------------------------
    #Tip
    ls4=EnumProperty(items=(("1","Balcony",""),("2","Parapet",""),("3","Mermer",""),("4","Krom",""),("5","Cam","")),default="4")
    #Balcony
    by4=IntProperty(name='Yukseklik',min=1,max=200,default=80,description='Yukseklik')
    bk4=IntProperty(name='Kalinlik', min=1,max= 50,default=20,description='Kalinlik' )
    bf4=IntProperty(name='Fuga',     min=0,max=  8,default= 0,description='Fuga'     )
    ...
    #Parapet
    py4=IntProperty(name='Yukseklik',min=1,max=200,default=80,description='Yukseklik')
    pd4=IntProperty(name='Kalinlik', min=1,max= 50,default=10,description='Kalinlik' )
    #Mermer
    my4=IntProperty(name='Yukseklik',min=1,max=50,default=4,description='Yukseklik')
    mg4=IntProperty(name='Genislik', min=0,max=20,default=4,description='Genislik' )
    #Krom
    kt4=EnumProperty(items=(("1","Kare",""),("2","Yuvarlak","")))
    ky4=IntProperty(min=0,max=50,default=5,description='Bosluk'  )
    kk4=IntProperty(min=1,max=20,default=5,description='Kalinlik')
    #Cam
    cy4=IntProperty(name='Yukseklik',min=1,max=100,default=20,description='Yukseklik')
    #--------------------------------------------------------------
    #Tip
    ls5=EnumProperty(items=(("1","Balcony",""),("2","Parapet",""),("3","Mermer",""),("4","Krom",""),("5","Cam","")),default="4")
    #Balcony
    by5=IntProperty(name='Yukseklik',min=1,max=200,default=80,description='Yukseklik')
    bk5=IntProperty(name='Kalinlik', min=1,max= 50,default=20,description='Kalinlik' )
    bf5=IntProperty(name='Fuga',     min=0,max=  8,default= 0,description='Fuga'     )
    ...
    #Parapet
    py5=IntProperty(name='Yukseklik',min=1,max=200,default=80,description='Yukseklik')
    pd5=IntProperty(name='Kalinlik', min=1,max= 50,default=10,description='Kalinlik' )
    #Mermer
    my5=IntProperty(name='Yukseklik',min=1,max=50,default=4,description='Yukseklik')
    mg5=IntProperty(name='Genislik', min=0,max=20,default=4,description='Genislik' )
    #Krom
    kt5=EnumProperty(items=(("1","Kare",""),("2","Yuvarlak","")))
    ky5=IntProperty(min=0,max=50,default=5,description='Bosluk'  )
    kk5=IntProperty(min=1,max=20,default=5,description='Kalinlik')
    #Cam
    cy5=IntProperty(name='Yukseklik',min=1,max=100,default=20,description='Yukseklik')
    #--------------------------------------------------------------
    #Tip
    ls6=EnumProperty(items=(("1","Balcony",""),("2","Parapet",""),("3","Mermer",""),("4","Krom",""),("5","Cam","")),default="4")
    #Balcony
    by6=IntProperty(name='Yukseklik',min=1,max=200,default=80,description='Yukseklik')
    bk6=IntProperty(name='Kalinlik', min=1,max= 50,default=20,description='Kalinlik' )
    bf6=IntProperty(name='Fuga',     min=0,max=  8,default= 0,description='Fuga'     )
    ...
    #Parapet
    py6=IntProperty(name='Yukseklik',min=1,max=200,default=80,description='Yukseklik')
    pd6=IntProperty(name='Kalinlik', min=1,max= 50,default=10,description='Kalinlik' )
    #Mermer
    my6=IntProperty(name='Yukseklik',min=1,max=50,default=4,description='Yukseklik')
    mg6=IntProperty(name='Genislik', min=0,max=20,default=4,description='Genislik' )
    #Krom
    kt6=EnumProperty(items=(("1","Kare",""),("2","Yuvarlak","")))
    ky6=IntProperty(min=0,max=50,default=5,description='Bosluk'  )
    kk6=IntProperty(min=1,max=20,default=5,description='Kalinlik')
    #Cam
    cy6=IntProperty(name='Yukseklik',min=1,max=100,default=20,description='Yukseklik')
    #--------------------------------------------------------------
    #Tip
    ls7=EnumProperty(items=(("1","Balcony",""),("2","Parapet",""),("3","Mermer",""),("4","Krom",""),("5","Cam","")),default="4")
    #Balcony
    by7=IntProperty(name='Yukseklik',min=1,max=200,default=80,description='Yukseklik')
    bk7=IntProperty(name='Kalinlik', min=1,max= 50,default=20,description='Kalinlik' )
    bf7=IntProperty(name='Fuga',     min=0,max=  8,default= 0,description='Fuga'     )
    ...
    #Parapet
    py7=IntProperty(name='Yukseklik',min=1,max=200,default=80,description='Yukseklik')
    pd7=IntProperty(name='Kalinlik', min=1,max= 50,default=10,description='Kalinlik' )
    #Mermer
    my7=IntProperty(name='Yukseklik',min=1,max=50,default=4,description='Yukseklik')
    mg7=IntProperty(name='Genislik', min=0,max=20,default=4,description='Genislik' )
    #Krom
    kt7=EnumProperty(items=(("1","Kare",""),("2","Yuvarlak","")))
    ky7=IntProperty(min=0,max=50,default=5,description='Bosluk'  )
    kk7=IntProperty(min=1,max=20,default=5,description='Kalinlik')
    #Cam
    cy7=IntProperty(name='Yukseklik',min=1,max=100,default=20,description='Yukseklik')
    #--------------------------------------------------------------
    def draw(self, context):
        layout = self.layout
        layout.prop(self,'prs')
        layout.prop(self,'lst')
        row=layout.row()
        row.prop(self,'luz')
        row.prop(self,'muz')
        row.prop(self,'ruz')
