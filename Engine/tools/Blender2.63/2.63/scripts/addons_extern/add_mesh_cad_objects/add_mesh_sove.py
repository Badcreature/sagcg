...
class OBJECT_OT_add_object(bpy.types.Operator):
    ...
    prs = EnumProperty(items = (("1","PENCERE 200",""),
                                ...
                                name="",description="")
    son=prs
    gen=IntProperty(name='Genislik', min=1,max= 400,default=200,description='Genislik')
    knr=IntProperty(name='Kalinlik', min=1,max= 100,default= 15,description='Kalinlik')
    yuk=IntProperty(name='Yukseklik',min=1,max=3000,default=590,description='Yukseklik')
    alt=IntProperty(name='Alt',      min=1,max= 300,default= 44,description='Alt Bosluk')
    ust=IntProperty(name='Ust',      min=1,max= 300,default= 33,description='Ust Bosluk')
    sdr=IntProperty(name='Derinlik', min=1,max= 100,default= 15,description='Sove Derinligi')
    pdr=IntProperty(name='Duvar',    min=0,max= 100,default= 20,description='Duvar Kalinligi')
    dh =IntProperty(name='',         min=1,max= 200,default= 30,description='Daire Yusekligi')
    dr=BoolProperty(name='Dairesel', default=True,  description='Dairesel')

    fg =IntProperty(name='Fuga',min=0,max=10,default=1,description='Fuga')
    fh =IntProperty(name='',    min=1,max=10,default=3,description='Yuseklik')
    fd =IntProperty(name='',    min=1,max=10,default=2,description='Derinlik')

    f0 =IntProperty(name='Aralik',min=1,max=3000,default=90,description='Aralik')
    f1 =IntProperty(name='Aralik',min=1,max=3000,default=30,description='Aralik')
    f2 =IntProperty(name='Aralik',min=1,max=3000,default=30,description='Aralik')
    f3 =IntProperty(name='Aralik',min=1,max=3000,default=30,description='Aralik')
    f4 =IntProperty(name='Aralik',min=1,max=3000,default=30,description='Aralik')
    f5 =IntProperty(name='Aralik',min=1,max=3000,default=30,description='Aralik')
    f6 =IntProperty(name='Aralik',min=1,max=3000,default=30,description='Aralik')
    f7 =IntProperty(name='Aralik',min=1,max=3000,default=30,description='Aralik')
    f8 =IntProperty(name='Aralik',min=1,max=3000,default=30,description='Aralik')
    f9 =IntProperty(name='Aralik',min=1,max=3000,default=30,description='Aralik')
    #--------------------------------------------------------------
