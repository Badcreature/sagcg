...
class OBJECT_PT_scenemassive(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        layout = self.layout
        row = layout.row()
        row.prop(sc,"EXTRACT_ALPHA",text='Extract Alpha Texture  (slow convertion)',icon='FORCE_TEXTURE')
        row = layout.row()
        row.prop(sc,"EXTRACT_PTEX",text='Extract Procedural Texture (slow convertion)',icon='FORCE_TEXTURE')        
